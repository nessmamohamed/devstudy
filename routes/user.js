              ...
              bcrypt.genSalt(10 , (err , salt)=>{
               ...
               var transporter = nodemailer.createTransport({
                   ...
                   var mailOptions = {
                       ...
                       subject: "Hello " + name,
                       text: 'Hello ' + email + '✔',
                       html: `<h2>Hello ${name} </h2> <br/> <h5> this is your  <a href = ${process.env.PORT} + /confirmation/${user._id}/${token} >verification link</a> </h3> <br/> <h5> please verify it to login to your account<h3/> ` 
                   }
